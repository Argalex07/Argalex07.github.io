...

{
    ...
    $sql = "UPDATE cocineta SET stock='$stockNuevo' WHERE id='$id' ";
    //Ejecutamos el Query
    $query = mysqli_query($conect , $sql);

if ($query) {
    //Header("Location: index.php");
    echo '<script language="javascript">alert("Venta Finalizada Con Exito");window.location.href="cocineta.php"</script>';
}
}
