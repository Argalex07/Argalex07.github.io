...
}else 
{
    ...
    $sql = "INSERT INTO cocineta VALUES ('$id','$name','$ref','$precio','$peso','$categoria','$stock','$fecha')";
    //Ejecutamos el Query
    ...
    echo '<script language="javascript">alert("Producto agregado con Exito");window.location.href="cocineta.php"</script>';
}
